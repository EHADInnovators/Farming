    ...
    public class AppAuthDialog : IDialog<object>
    {
            ...
            IAwaitable<AuthResult> awaitableAuthResult)
        {
            try
            {
                ...
                IUserData icro = ServiceLocator.GetUserData();
                ...
                authContext.Call(new FarmingAssistanceDialog(), this.ResumeAfterFarmingQueryDialog);
        ...
        private async Task ResumeAfterFarmingQueryDialog(IDialogContext context, IAwaitable<object> result)
        {
            try
            {
